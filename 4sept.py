...
client = pymongo.MongoClient("mongodb+srv://Rakeshbind:rakeshbind24@cluster0.1gmcgva.mongodb.net/?retryWrites=true&w=majority")
db = client.test
...
database2 = client['4septdatabase']
collection = database2["tryingtoadd"]
collection1=database2["newcollection"]
